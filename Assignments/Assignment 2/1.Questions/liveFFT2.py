...
class live_FFT2():
    ...
    def __init__(self, **kwargs):
        ...
        if self.use_camera == False:
            # No camera!
            self.im = rgb2gray(img_as_float(io.imread('./data/yann-lecun.jpg')))
        else:
            # We found a camera!
        ...
        self.imJack = rgb2gray(img_as_float(io.imread('./data/JacksonGibbonsCrop.png')))
    ...
    def camimage_ft(self):
        ...
        #                
        # Students:
        # This code reads an image from your webcam. If you have no webcam,
        # then it will use a picture of Yann LeCun (courtesy of NYU).
        # That being said, the exercise is much less fun!
        #
        ...
        newImage = np.fft.ifft2( rec ).imag + np.fft.ifft2( rec ).real
