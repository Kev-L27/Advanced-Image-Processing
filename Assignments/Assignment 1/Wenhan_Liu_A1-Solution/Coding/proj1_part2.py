...
save_image('low_frequencies.jpg', low_frequencies)
save_image('high_frequencies.jpg', np.clip(high_frequencies+0.5, 0.0, 1.0))
save_image('hybrid_image.jpg', np.clip(hybrid_image, 0.0, 1.0))
save_image('hybrid_image_scales.jpg', np.clip(vis, 0.0, 1.0))
